...
~/.openclaw/workspace/skills/context-manager/compress.sh list

# Check status of a specific session
~/.openclaw/workspace/skills/context-manager/compress.sh status agent:main:main

# Generate AI summary (read-only, safe)
~/.openclaw/workspace/skills/context-manager/compress.sh summarize agent:main:main

# Compress session: generate summary, reset, inject (DESTRUCTIVE)
~/.openclaw/workspace/skills/context-manager/compress.sh summarize agent:main:main --replace
```
